...
To generate the data, run 'benchmark_speed.R' using 'benchmark_speed.sh'
...
Plot memory analysis with 200,000 cells. To generate the data, run 'memory_sim.R' using 'benchmark_speed.sh'
...
To generate the data, run 'benchmark_speed.R' (bottom section) using 'benchmark_speed.sh'
...
To generate this data, run 'benchmark_million.R' using 'benchmark_speed.sh'
