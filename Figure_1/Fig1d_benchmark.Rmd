...
method_names <- c("reduced_dim", "graph")
method_colors <- RColorBrewer::brewer.pal(7, name="Spectral")[c(5,6)]
method_colors <- c("#FC8D59", "#99d594")
...
3. Run 'submit_make_bm_data.sh'. Make sure you activate read/write/execute permissions! This creates DA simulations for the different populations of cells.
4. Run 'submit_benchmark.sh'. This runs the two methods we are trying to compare (reduced_dim and graph) on the simulations. 
...
read4_prob_hist <- function(data_id){
  outdir <- glue("/Users/kluzer01/Documents/Milo2.0/R_scripts/milo_analysis_2020/benchmark/data/output_benchmark/")
...
4. Run 'submit_benchmark.sh'.

Plot distribution of P(C1) in cells identified as DA by different methods

```{r, fig.height=8, fig.width=18}

embryo_res_df <- read.csv("/Users/kluzer01/Documents/Milo2.0/R_scripts/milo_analysis_2020/benchmark/data/embryo_res_df.csv")
...
Read outcome for embryo (built with wrapper `build_outcome.R`). Don't forget to add embryo_thresh to build_outcome.R!

```{r}
outcome_df <- read_csv("/Users/kluzer01/Documents/Milo2.0/R_scripts/milo_analysis_2020/benchmark/data/output_benchmark/outcome_embryo_batchEffect0.csv")
```
...
outdir <- "/Users/kluzer01/Documents/Milo2.0/R_scripts/milo_analysis_2020/benchmark/data/output_benchmark"
...
pl_signal2noise <- function(mypop, myenr, myseed, mymethod){
  ...
  res_file <- list.files("/Users/kluzer01/Documents/Milo2.0/R_scripts/milo_analysis_2020/benchmark/data/output_benchmark", 
