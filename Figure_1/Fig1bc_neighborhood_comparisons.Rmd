...
This file contains all the code needed to re-create Figures 1b and 1c. 
...
nh_stats %>%
  ...
  #scale_fill_manual(values = c("#fdae61", "#ffffbf", "#abd9e9"), name="Sampling scheme", labels = c("random", "reduced_dim", "graph")) +
...
nh_stats %>%
  ...
  scale_fill_brewer(palette = "Set2", name="Sampling scheme", labels = c("Random", "Reduced dim", "Graph")) +
  #scale_fill_manual(values = c("#ffffbf", "#FC8D59", "#99d594"), name="Sampling scheme", labels = c("random", "reduced_dim", "graph")) +
  theme_bw(base_size=16) + 
  theme(legend.position="none", axis.text.x=element_text(colour="black"), axis.text.y=element_text(colour="black"))
ggsave("1c.tiff", path = "/Users/kluzer01/Desktop/figures/", height = 4, width = 4.5, device='tiff', dpi=700) 
```